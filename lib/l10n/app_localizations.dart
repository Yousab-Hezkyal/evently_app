...
abstract class AppLocalizations {
  ...
  /// No description provided for @empty_pass_error.
  ///
  /// In en, this message translates to:
  /// **'Password cannot be empty'**
  String get empty_pass_error;
  ...
  /// No description provided for @empty_re_pass_error.
  ///
  /// In en, this message translates to:
  /// **'Re Password cannot be empty'**
  String get empty_re_pass_error;

  /// No description provided for @re_pass_error.
  ///
  /// In en, this message translates to:
  /// **'Passwords must match'**
  String get re_pass_error;
